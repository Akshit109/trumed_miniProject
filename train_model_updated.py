# ====================================================================
# UPDATED TRAIN MODEL - Works with Symptom2Disease.csv
# Converts text descriptions to binary symptom features
# ====================================================================
...
# ====================================================================
# SYMPTOM LIST - 131 Symptoms from your model
# ====================================================================
...
# ====================================================================
# TEXT TO SYMPTOM MAPPING
# ====================================================================

def extract_symptoms_from_text(text):
    """Extract symptoms from patient text description"""
    ...
    symptom_keywords = {
        ...
        'joint_pain': ['joint pain', 'joints hurt', 'arthralgia'],
        ...
        'skin_peeling': ['peeling', 'skin peeling', 'flaking skin'],
        ...
        'silver_like_dusting': ['dusting', 'silver dust', 'scales'],
        'small_dents_in_nails': ['dents in nails', 'nail pits', 'pitted nails'],
        'inflammatory_nails': ['nail inflammation', 'inflammatory nails', 'inflamed nails'],
        'blister': ['blister'],
...
def preprocess_text_to_binary(df):
    """Convert text descriptions to binary symptom matrix"""
    ...
    for idx, row in df.iterrows():
        ...
        for symptom in detected:
            if symptom in SYMPTOMS_LIST:
                symptom_matrix.at[idx, symptom] = 1
    
    # Add disease label
    symptom_matrix['prognosis'] = df['label']
    
    print(f"✓ Processed {len(df)} records")
    print(f"✓ Average symptoms per record: {symptom_matrix[SYMPTOMS_LIST].sum(axis=1).mean():.2f}")
...
def train_model_from_csv(csv_path='Symptom2Disease.csv'):
    """Train model from Symptom2Disease CSV"""
    ...
    print("\n2. Converting text descriptions to binary features...")
    binary_data = preprocess_text_to_binary(df)
    ...
    print(f"✓ Diseases: {len(le_target.classes_)}")
    print(f"✓ Disease list: {list(le_target.classes_)}")
    ...
    # Create explainers
    print("8. Creating explainability models...")
    ...
    model_package = {
        ...
        'lime_explainer': None,  # Will be created at runtime
    ...
    return model, scaler, le_target, accuracy
...
if __name__ == "__main__":
    # Train the model
    model, scaler, le_target, accuracy = train_model_from_csv('Symptom2Disease.csv')
